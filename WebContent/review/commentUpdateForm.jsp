	...
	<section id="blog">
		 ...
		 <div class="container">
            <div class="row contact-wrap"> 
                ...
                <form action="Comment_UpdatePro.re" name="writeForm" method="post" onsubmit="return writeCheck()">
                    <div class="col-sm-offset-1">
                      ...
                      <div class="col-sm-10 ">
                            ...
                            <textarea id="summernote" name="rc_content" class="r_content" required>${article.rc_content }</textarea>
