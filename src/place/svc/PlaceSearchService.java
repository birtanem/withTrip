...
public class PlaceSearchService {
	...
	public int getListCount(String search) {
		...
		listCount = placeDAO.selectSearchListCount(search);
	...
	public ArrayList<PlaceBean> getArticleList(int page, int limit, String search) {
		...
		articleList = placeDAO.selectArticleList(page, limit, search);
